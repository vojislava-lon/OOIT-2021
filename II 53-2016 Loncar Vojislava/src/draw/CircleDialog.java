...
public class CircleDialog extends JDialog {
	...
	public CircleDialog() {
		...
		contentPanel.setLayout(gbl_contentPanel);
		{
			...
			lblCenter.setFont(new Font("Comic Sans MS", Font.BOLD, 13));
		...
		{
			JButton btnFillColorCircle = new JButton("Choose fill color");
			...
			gbc_btnFillColorCircle.insets = new Insets(0, 0, 5, 5);
		...
		}
		{
			...
			gbc_textFillColorCircle.insets = new Insets(0, 0, 5, 5);
		...
		{
			{
				...
				lblRadius.setFont(new Font("Comic Sans MS", Font.BOLD, 12));
		...
		{
			JButton btnBorderColorCircle = new JButton("Choose border color");
			...
			gbc_btnBorderColorCircle.insets = new Insets(0, 0, 5, 5);
		...
		}
		{
			...
			gbc_textBorderColorCircle.insets = new Insets(0, 0, 5, 5);
